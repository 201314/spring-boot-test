...
public final class ObjectId implements Comparable<ObjectId>, Serializable {
    ...
    public ObjectId(final String hexString) {
        this(ByteBuffer.wrap(parseHexString(hexString)));
    }
    ...
    public ObjectId(final ByteBuffer buffer) {
        AssertUtil.notNull(buffer, BaseErrorCode.INVALID_PARAMETERS);
        AssertUtil.isTrue(buffer.remaining() >= OBJECT_ID_LENGTH, BaseErrorCode.INVALID_PARAMETERS);
