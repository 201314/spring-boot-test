package com.gitee.log.aop.util;
...
public class DiffUtil {
	public static Object getObjectById(Object proxy, Object target, Object id)
			throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
		Method findMethod = target.getClass().getMethod("selectById", Long.class);
	...
	public static Object getObjectById(Class<?> target, Object id)
			throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
		Object obj = null;
		try {
			obj = Class.forName(target.getName()).newInstance();
		...
		Method findMethod = obj.getClass().getMethod("selectById", Long.class);
		Object oldObj = findMethod.invoke(target, id);
		return oldObj;
	}
	...
	public static Map<String, String> getFieldNameMap(Class<?> clz) {
		...
		for (Field field : clz.getDeclaredFields()) {
			if (field.isAnnotationPresent(OperationLog.class)) {
				OperationLog datalog = field.getAnnotation(OperationLog.class);
